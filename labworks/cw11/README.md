...
4. Скопируйте программу ещё раз и измените её согласно варианту, который Вам **выдал преподаватель**.
...
* для вариантов с 11 по 20 следует вместо типа _int_ использовать _byte_ (и понять отличие этих типов данных);
...
6. Переведите число `0x...` в 10-ричную систему счисления?
7. Переведите число `...` в 16-ричную систему счисления?